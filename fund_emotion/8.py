...
# 读取股票信息表格
df = pd.read_csv('data_merge_lstm/fund_Price_fill.csv')
# 删除缺少值
df = df.dropna()
...
MSE   = mean_squared_error(y_p, y_real)
RMSE  = mean_squared_error(y_p, y_real)**0.5
MAE   = mean_absolute_error(y_p, y_real)
R2    = r2_score(y_p, y_real)
